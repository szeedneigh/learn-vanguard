            ...
            <CardContent className="p-4">
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-semibold text-slate-800">Today&apos;s Events</h2>
                  <Button 
                    variant="ghost" 
                    size="sm"
                    asChild
                    ...
                    >
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <span className={`px-3 py-1.5 rounded-full text-xs font-medium ${getEventTypeStyles(event.type)}`}>
                            {event.type}
                          </span>
                        </div>
                      </CardContent>
