...
function TaskDetailDialog({
  ...
  logger.log("TaskDetailDialog - Creator ID extraction:", {
    isTask,
  ...
  logger.log("TaskDetailDialog - Item analysis:", {
  ...
  logger.log("TaskDetailDialog - Ownership check:", {
    hasUser: !!user,
  ...
  if (isTask) {
    ...
    logger.log("TaskDetailDialog - Checking event permissions...", {
    ...
    logger.log("TaskDetailDialog - Permission check results:", {
    ...
    logger.log("TaskDetailDialog - Event permissions:", {
      isOwnItem,
      isAdmin,
      isPIO,
