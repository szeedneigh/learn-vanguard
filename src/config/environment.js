...
const apiBaseUrl =
  ensureValidUrl(import.meta.env.VITE_API_BASE_URL) ||
  (isProduction
    ? "https://learn-vanguard-server.onrender.com/api"
    : "http://localhost:5000/api");

const backendUrl =
  ensureValidUrl(import.meta.env.VITE_BACKEND_URL) ||
  (isProduction
...
export const environment = {
  ...
  WS_URL:
    ...
    (isProduction
      ? "wss://learn-vanguard-server.onrender.com/ws"
